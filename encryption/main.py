...
def main_screen():
    ...
    Label(text = "Enter text for encryption or decryption", font=('calibri', 13), fg='black').place(x=10, y=10)
    text1 = Text(font = 'Robote 20', bg = 'white', relief= GROOVE, wrap = WORD, bd = 0)
    text1.place(x=10, y=50, width = 355, height=100)

    Label(text = "Enter secret key for encr and decr", fg='black', font=('calibri', 13)).place(x=10, y=170)
